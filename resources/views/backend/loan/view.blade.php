                  ...
                  <table class="table table-bordered data-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-right">
                              {{ decimalPlace($payment['amount_to_pay'] - $payment['interest'], currency($loan->currency->name)) }}
                           </td>
                           <td class="text-right">
                           ...
                           <td class="text-right">
                              {{ decimalPlace($payment['amount_to_pay'] + $payment['late_penalties'], currency($loan->currency->name)) }}
                           </td>
                        </tr>
                        @endforeach
                     </tbody>
