...
<section class="section testimonial">
	<div class="testimonial-bg" style="background: url(<?php echo e(get_option('about_us_image') == '' ? asset('theme/images/about-us-main.jpg'): media_images(get_option('about_us_image'))); ?>)"></div>
	<div class="container">
		<div class="row">
...
<?php echo $__env->make('theme.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/kdb_secure_bank/resources/views/theme/about.blade.php ENDPATH**/ ?>