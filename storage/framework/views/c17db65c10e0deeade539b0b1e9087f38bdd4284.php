				...
				<div class="card-body">
                    ...
                    <form method="POST" class="form-signup" autocomplete="off" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="tele_banking_pin" type="password" placeholder="<?php echo e(_lang('Tele Banking Pin')); ?>" class="form-control<?php echo e($errors->has('tele_banking_pin') ? ' is-invalid' : ''); ?>" name="tele_banking_pin" required>

                                <?php if($errors->has('tele_banking_pin')): ?>
                                    <span class="invalid-feedback">
                                        <strong><?php echo e($errors->first('tele_banking_pin')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
