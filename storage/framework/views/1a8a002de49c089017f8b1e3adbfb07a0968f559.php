...
<!-- Slider Start -->
<section class="banner d-flex align-items-center" style="background: url(<?php echo e(get_option('home_banner') == '' ? asset('theme/images/slider-bg-1.jpg') : media_images(get_option('home_banner'))); ?>)">
	<div class="container">
		<div class="row">
			<div class="col-lg-8">
				<div class="block">
...
<section class="section about">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6">
				<div class="about-img">
					<img src="<?php echo e(get_option('home_about_us_banner') == '' ? asset('theme/images/about-us.jpg') : media_images(get_option('home_about_us_banner'))); ?>" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-6">
...
<?php echo $__env->make('theme.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/kdb_secure_bank/resources/views/theme/index.blade.php ENDPATH**/ ?>